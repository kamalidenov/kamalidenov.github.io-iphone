  	...
  	<div class="row">
  		<div class="col-sm-8">
			...
			<nav id="menu" class="navbar">
			    <div class="navbar-header"><span class="toggle-top-text hidden-md hidden-sm hidden-lg"><?php echo $text_information; ?>:</span>
			        ...
			        <?php if ($informations) { ?>
						<ul class="nav navbar-nav">
							<?php foreach ($informations as $information) { ?>
								<li>
									<a href="<?php echo $information['href']; ?>"><?php echo $information['title']; ?>	
									</a>
								</li>
							<?php } ?>
						</ul>
  		...
  		<div class="col-sm-4 cart-wrapper">
  			<?php echo $cart; ?>
  		</div>
  	</div>
